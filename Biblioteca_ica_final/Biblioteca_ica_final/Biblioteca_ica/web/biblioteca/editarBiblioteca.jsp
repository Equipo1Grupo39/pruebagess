    ...
    function enviarForma(enviar)
        {
            ...
            var nit = document.forms["editar"]["nit"];
            var email = document.forms["editar"]["email"];
            var direccion = document.forms["editar"]["direccion"];
            var telefono = document.forms["editar"]["telefono"];
            var cuenta = document.forms["editar"]["cuenta"];
            var banco = document.forms["editar"]["banco"];
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title">Editar Biblioteca</h3>
                                </div>            
                                <div class="card-body">
                                    <form name="editar" class="form-signin" method="post" action="<%=request.getContextPath()%>/tbibliotecaController">  
                                        <input type="hidden" name="action" value="editar">
                                        <input type="hidden" name="codigo" value="${biblioteca.idtbiblioteca}">
                                            <table class="table table-bordered table-hover">
                                                <tr>
                                                    <td>Código: </td>
                                                    <td><input type="text" size="50" value="${biblioteca.idtbiblioteca}" disabled = "true" required></td>
                                                </tr>                    
                                                <tr>
                                                    <td>Nombre: </td>
                                                    <td><input type="text" id="nombre" name="nombre" size="50" maxlength="45" value="${biblioteca.tbinombre}" required></td>
                                                </tr>
                                                <tr>
                                                    <td>Nit: </td>
                                                    <td><input type="number" id="nit" name="nit" size="50" maxlength="9" value="${biblioteca.tbinit}" required></td>
                                                </tr>
                                                <tr>
                                                    <td>Email: </td>
                                                    <td><input type="text" id="email" name="email" size="50" value="${biblioteca.tbiemail}" required></td>
                                                </tr>
                                                <tr>
                                                    <td>Dirección: </td>
                                                    <td><input type="text" id="direccion" name="direccion" size="50" value="${biblioteca.tbidireccion}" required></td>
                                                </tr>
                                                <tr>
                                                    <td>Teléfono: </td>
                                                    <td><input type="text" id="telefono" name="telefono" size="50" value="${biblioteca.tbitelefono}" required></td>
                                                </tr>
                                                <tr>
                                                    <td>Cuenta bancaria: </td>
                                                    <td><input type="text" id="number" name="cuenta" size="50" value="${biblioteca.tbicuentabancaria}" required></td>
                                                </tr>
                                                <tr>
                                                    <td>Nombre banco: </td>
                                                    <td><input type="text" id="banco" name="banco" size="50" value="${biblioteca.tbinombrebanco}" required></td>
                                                </tr>

                                            </table>
                                            <br />
                                            <div class="modal-footer justify-content-between">
                                                <input type= "submit" onclick="javascript:enviarForma('editar')" class="btn btn-primary " value="Guardar"></a>&nbsp;
                                            </div>
                                    </form>
                                </div>
                            </div>
