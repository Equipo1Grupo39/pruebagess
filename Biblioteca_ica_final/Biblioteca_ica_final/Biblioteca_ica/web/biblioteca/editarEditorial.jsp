                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form name="editar" class="form-signin" method="post" action="<%=request.getContextPath()%>/editorialcontroller">  
                                        <input type="hidden" name="action" value="editar">
                                        <input type="hidden" name="codigo" value="${editorial.codigoeditorial}">
                                            <table class="table table-bordered table-hover">
                                                <tr>
                                                    <td>Código: </td>
                                                    <td><input type="text" size="50" value="${editorial.codigoeditorial}" disabled = "true"></td>
                                                </tr>                    
                                                <tr>
                                                    <td>Nombre:</td>
                                                    <td><input type="text" id="nombre" name="nombre" size="50" value="${editorial.edinombreeditorial}" required></td>
                                                </tr>
                                            </table>
                                            <br />
