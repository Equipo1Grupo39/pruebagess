...
<script>
    function enviarForma(enviar)
        {
            var cedula = document.forms["crear"]["cedula"];
            var nombre = document.forms["crear"]["nombre"];
            var mail = document.forms["crear"]["mail"];
            var direccion = document.forms["crear"]["direccion"];
            var telefono = document.forms["crear"]["telefono"];
            var usuario = document.forms["crear"]["usuario"];
            var contrasena = document.forms["crear"]["contrasena"];
    ...
    function mostrarUsuario(sel) {
        var selectedText = sel.options [sel.selectedIndex].innerHTML;
        var selectedValue = sel.value;
        var doc = document.getElementById("cedula").value;
        
        if (doc == ''){
            alert("Por favor ingrese la cédula para poder continuar");
            document.getElementById("cedula").focus();
            sel.selectedIndex = 0;
        } else {
            if(selectedValue == 'U'){
                document.crear.usuario.value = doc;
                document.getElementById("usuario").disabled = true;
            } else {
                document.crear.usuario.value = '';
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form name="crear" class="form-signin" method="post" action="<%=request.getContextPath()%>/usuariocontroller">  
                                        <input type="hidden" name="action" value="register">
                                        <table class="table table-bordered table-hover">
                                            <tr>
                                                <td>Cédula: </td>
                                                <td><input type="text" id="cedula" name="cedula" size="50" required></td>
                                            </tr>
                                            ...
                                            <tr>
                                                <td>Mail: </td>
                                                <td><input type="text" name="mail" size="50" required></td>
                                            </tr>
                                            <tr>
                                                <td>Dirección:  </td>
                                            ...
                                            <tr>
                                                <td>Tipo: </td>
                                                <td>
                                                    <select name="tipo" onchange = "mostrarUsuario(this)">
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="text" id="usuario" name="usuario" size="50" required></td> 
                                            </tr>
                                            <tr>
                                                <td>Contraseña:  </td>
                                                <td><input type="password" name="contrasena" size="12" required></td>
                                            </tr>                    
                                        </table>
                                        <br/>
