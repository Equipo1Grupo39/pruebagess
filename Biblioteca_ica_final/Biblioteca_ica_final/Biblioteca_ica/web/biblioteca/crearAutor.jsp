    ...
    function enviarForma(enviar)
        {
            ...
            var nacionalidad = document.forms["crear"]["nacionalidad"];
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title">Crear Autor</h3>
                                </div>            
                                <div class="card-body">
                                    <form name="crear" class="form-signin" method="post" action="<%=request.getContextPath()%>/autorcontroller">  
                                        ...
                                        <table class="table table-bordered table-hover">
                                            ...
                                            <tr>
                                                <td>Nacionalidad:</td>
                                                <td><input type="text" name="nacionalidad" size="50" required></td>
                                            </tr>
                                        </table>
                                        <br />
                                        <div class="modal-footer justify-content-between">
                                            <input type= "submit" onclick="javascript:enviarForma('register')" class="btn btn-primary ">Guardar</a>&nbsp;
                                        </div>
                                    </form>
                                </div>
                            </div>
