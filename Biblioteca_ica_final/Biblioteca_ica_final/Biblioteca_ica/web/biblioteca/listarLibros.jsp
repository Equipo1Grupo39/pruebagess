        ...
        <div class="wrapper">    
            ...
            <div class="content-wrapper">
                ...
                <div class="content-header">
                    ...
                    <a href="libroscontroller?action=nuevo" class="btn btn-success">Crear Libro</a>&nbsp;                 
                </div>            
                                        ...
                                        <tbody>
                                            <c:forEach var="libros" items="${lista}">
                                                <tr>
                                                    ...
                                                    <td> <c:out value="${libros.autnombresapellidos}"/></td>
                                                    <td> <c:out value="${libros.matnombremateria}"/></td>
                                                    <td> <c:out value="${libros.edinombreeditorial}"/></td>
                                                    <td> <c:out value="${libros.idinombreidioma}"/></td>
                                                    <td> <c:out value="${libros.libcodigosignaturatopografica}" /></td>
                                                    <td> <c:out value="${libros.invcantidad}" /></td>
                                                    <td> <c:out value="${libros.disponibles}" /></td>
                                                    <td> <c:out value="${libros.libfechacreacion}"/></td>
                                                    <td><a class="btn btn-warning" href="libroscontroller?action=showedit&codigo=<c:out value="${libros.codigolibroisbn}" />">Editar</a></td>
                                                    <td><a class="btn btn-danger" href="libroscontroller?action=eliminar&codigo=<c:out value="${libros.codigolibroisbn}"/>">Eliminar</a> </td>	                        
                                                </tr>
                                            </c:forEach>
                                            </tbody>
                                        </table>
