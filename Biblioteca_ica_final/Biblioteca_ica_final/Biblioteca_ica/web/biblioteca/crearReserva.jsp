...
<script>
    function enviarForma(enviar)
        {
            var usuarioRe = document.forms["crear"]["usuarioRe"];
            var libro = document.forms["crear"]["libro"];
            var audio = document.forms["crear"]["audio"];
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title">Registrar Reserva</h3>
                                </div>            
                                <div class="card-body">
                                    <form name="crear" class="form-signin" method="post" action="<%=request.getContextPath()%>/reservascontroller">  
                                                ...
                                                <td>
                                                    <select name="usuarioRe" required>
                                                        ...
                                                        <c:forEach var="usuario" items="${listaUsuario}">
                                                            <option value="${usuario.idusuario}">${usuario.usulogin} - ${usuario.usunombresapellidos}</option>
                                                        </c:forEach>
                                                    </select> 
                                                </td>                          
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <select name="administrador">
                                                        <c:forEach var="administrador" items="${listaAdmon}">
                                                            <option value="${administrador.idusuario}">${administrador.usulogin} - ${administrador.usunombresapellidos}</option>
                                                        </c:forEach>
                                                    </select> 
                                                </td>                          
                                            </tr>                    
                                                ...
                                                <td>
                                                    <select name="libro" required>
                                                        ...
                                                        <c:forEach var="libro" items="${listaLibros}">                              
                                                            <option value="${libro.codigolibroisbn}">${libro.libtitulo}</option>
                                                        </c:forEach>
                                                    </select> 
                                                </td>                          
                                            </tr>   
                                                ...
                                                <td>
                                                    <select name="audio" required>
                                                        ...
                                                        <c:forEach var="audio" items="${listaAudios}">
                                                            <option value="${audio.codigoaudiosyvideosisbn}">${audio.ayVtitulo}</option>
                                                        </c:forEach>
                                                    </select> 
                                                </td>                          
                                            </tr>
