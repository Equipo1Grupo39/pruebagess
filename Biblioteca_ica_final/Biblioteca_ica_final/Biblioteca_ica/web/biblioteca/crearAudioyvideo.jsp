                ...
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6" style="padding-right: unset; padding-left: unset">
                            <h1 class="m-0 text-dark">Audio y video</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="#">Menu Principal</a></li>
                                <li class="breadcrumb-item active">Audio y video</li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->                       
                </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title">Crear Audio y video</h3>
                                </div>            
                                <div class="card-body">
                                    <form name="crear" class="form-signin" method="post" action="<%=request.getContextPath()%>/audiosyvideoscontroller">  
                                        <input type="hidden" name="action" value="register">
                                        <table class="table table-bordered table-hover">
                                            <tr>
                                                <td>Código: </td>
                                                <td><input type="text" name="codigo" size="100" required></td>
                                            </tr> 
                                            <tr>
                                                <td>Título:  </td>
                                                <td><input type="text" name="titulo" size="100" required></td>
                                            </tr> 
                                            <tr>
                                                <td>Contenido: </td>
                                                <td><input type="text" name="contenido" size="50" required></td>     
                                            </tr>  
                                            <tr>
                                                <td>Autor: </td>
                                                <td>
                                                    <select name="autor">
                                                        <c:forEach var="autor" items="${listaAutor}">
                                                            <option value="${autor.codigoautor}">${autor.autnombresapellidos}</option>
                                                        </c:forEach>
                                                    </select> 
                                                </td>                          
                                            </tr>
                                                ...
                                                <td>
                                                    <select name="materia">
                                                        <c:forEach var="materia" items="${listaMateria}">
                                                            <option value="${materia.codigomateria}">${materia.matnombremateria}</option>
                                                        </c:forEach>
                                                    </select> 
                                                </td>                          
                                            </tr>
                                                ...
                                                <td>
                                                    <select name="editorial">
                                                        <c:forEach var="editorial" items="${listaEditorial}">
                                                            <option value="${editorial.codigoeditorial}">${editorial.edinombreeditorial}</option>
                                                        </c:forEach>
                                                    </select> 
                                                </td>                          
                                            </tr>
                                                ...
                                                <td>
                                                    <select name="idioma">
                                                        <c:forEach var="idioma" items="${listaIdioma}">
                                                            <option value="${idioma.codigoidioma}">${idioma.idinombreidioma}</option>
                                                        </c:forEach>
                                                    </select> 
                                                </td>                          
                                            </tr>
                                        ...
                                        <table class="table table-bordered table-hover">
                                            <tr>
                                                <td>Código: </td>
                                                <td><input type="text" name="signatura" size="100" required></td>
                                            </tr> 
                                            <tr>
                                                <td>Biblioteca: </td>
                                                <td>
                                                    <select name="biblioteca">
                                                        <c:forEach var="biblioteca" items="${listaBiblioteca}">
                                                            <option value="${biblioteca.idtbiblioteca}">${biblioteca.tbinombre}</option>
                                                        </c:forEach>
                                                    </select> 
                                                </td>                          
                                            </tr> 
                                        ...
                                        <table class="table table-bordered table-hover">
                                            <tr>
                                                ...
                                                <td><input type="number" name="cantidad" size="10" required></td>
                                            </tr> 
                                        </table>
                                        <br />                
