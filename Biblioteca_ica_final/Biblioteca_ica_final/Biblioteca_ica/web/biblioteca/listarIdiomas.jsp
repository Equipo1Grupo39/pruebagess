...
<html>
    <head>
        ...
        <title>Idiomas | Sistema Biblioteca</title>
        ...
        <div class="wrapper">    
                        ...
                        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                            ...
                            <li class="nav-item has-treeview menu-open">
                                ...
                                <ul class="nav nav-treeview">
                                    ...
                                    <li class="nav-item">
                                        <a href="<%=request.getContextPath()%>/idiomacontroller?action=mostrar" class="nav-link active">
            ...
            <div class="content-wrapper">
                ...
                <div class="content-header">
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6" style="padding-right: unset; padding-left: unset">
                                <h1 class="m-0 text-dark">Idiomas</h1>
                            </div><!-- /.col -->
                            <div class="col-sm-6">
                    ...
                    <a href="idiomacontroller?action=nuevo" class="btn btn-success">Crear Idioma</a>&nbsp;                 
                </div>            
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <table class="table table-bordered table-hover">
                                            ...
                                            <tbody>
                                            <c:forEach var="idioma" items="${lista}">
                                                <tr>
                                                    <td> <c:out value="${idioma.codigoidioma}"/></td>
                                                    <td> <c:out value="${idioma.idinombreidioma}"/></td>
                                                    <td><a class="btn btn-warning" href="idiomacontroller?action=showedit&codigo=<c:out value="${idioma.codigoidioma}" />">Editar</a></td>
                                                    <td><a class="btn btn-danger" href="idiomacontroller?action=eliminar&codigo=<c:out value="${idioma.codigoidioma}"/>">Eliminar</a> </td>	                        
                                                </tr>
                                            </c:forEach>
                                            </tbody>
                                        </table>
