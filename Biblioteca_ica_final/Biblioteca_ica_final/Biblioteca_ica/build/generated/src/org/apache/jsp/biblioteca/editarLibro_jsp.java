...
public final class editarLibro_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("        {\n");
      out.write("            var codigo = document.forms[\"editar\"][\"codigo\"];\n");
      out.write("            var titulo = document.forms[\"editar\"][\"titulo\"];\n");
      out.write("            var paginas = document.forms[\"editar\"][\"paginas\"];\n");
      out.write("            var signatura = document.forms[\"editar\"][\"signatura\"];\n");
      out.write("            var cantidad = document.forms[\"editar\"][\"cantidad\"];\n");
      out.write("            \n");
      ...
      out.write("            }            \n");
      out.write("\n");
      out.write("            if (paginas.value == \"\") {\n");
      out.write("                paginas.focus();\n");
      out.write("                return false;\n");
      out.write("            }            \n");
      out.write("\n");
      ...
      out.write("                                    <h3 class=\"card-title\">Editar Libro</h3>\n");
      out.write("                                </div>            \n");
      out.write("                                <div class=\"card-body\">\n");
      out.write("                                    <form name=\"editar\" class=\"form-signin\" method=\"post\" action=\"");
      out.print(request.getContextPath());
      out.write("/libroscontroller\">  \n");
      out.write("                                        <input type=\"hidden\" name=\"action\" value=\"editar\">\n");
      out.write("                                        <input type=\"hidden\" name=\"codigoAntLib\" value=\"");
      ...
      out.write("\">\n");
      out.write("                                        <input type=\"hidden\" name=\"codigoAntSig\" value=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${signatura.codigosignaturatopografica}", java.lang.String.class, (PageContext)_jspx_page_context, null));
      out.write("\">\n");
      ...
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${libro.codigolibroisbn}", java.lang.String.class, (PageContext)_jspx_page_context, null));
      out.write("\"  size=\"100\" required></td>\n");
      out.write("                                                </tr> \n");
      out.write("                                                <tr>\n");
      ...
      out.write("                                                </tr> \n");
      out.write("                                                <tr>\n");
      out.write("                                                    <td>Número de páginas: </td>\n");
      out.write("                                                    <td><input type=\"number\" name=\"paginas\" value=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${libro.libnumerodepaginas}", java.lang.String.class, (PageContext)_jspx_page_context, null));
      ...
      out.write("                                                <tr>\n");
      out.write("                                                    <td>Código: </td>\n");
      out.write("                                                    <td><input type=\"text\" name=\"signatura\" size=\"100\" value=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${signatura.codigosignaturatopografica}", java.lang.String.class, (PageContext)_jspx_page_context, null));
      ...
      out.write("                                                    <td><input type=\"number\" name=\"cantidad\" size=\"10\" value=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${libro.invcantidad}", java.lang.String.class, (PageContext)_jspx_page_context, null));
      out.write("\" required></td>\n");
      out.write("                                                </tr> \n");
      out.write("                                            </table>\n");
      out.write("                                            <br />                \n");
    ...
    try {
      ...
      if (_jspx_eval_c_forEach_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          ...
          out.write('"');
          out.write(' ');
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${autor.codigoautor == libro.libcodigoautor?\"selected\":\"\"}", java.lang.String.class, (PageContext)_jspx_page_context, null));
          out.write('>');
    ...
    try {
      ...
      if (_jspx_eval_c_forEach_1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          ...
          out.write('"');
          out.write(' ');
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${materia.codigomateria == libro.libcodigomateria?\"selected\":\"\"}", java.lang.String.class, (PageContext)_jspx_page_context, null));
          out.write('>');
    ...
    try {
      ...
      if (_jspx_eval_c_forEach_2 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          ...
          out.write('"');
          out.write(' ');
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${editorial.codigoeditorial == libro.libcodigoeditorial?\"selected\":\"\"}", java.lang.String.class, (PageContext)_jspx_page_context, null));
          out.write('>');
    ...
    try {
      ...
      if (_jspx_eval_c_forEach_3 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          ...
          out.write('"');
          out.write(' ');
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${idioma.codigoidioma == libro.libcodigoidioma?\"selected\":\"\"}", java.lang.String.class, (PageContext)_jspx_page_context, null));
          out.write('>');
    ...
    try {
      ...
      if (_jspx_eval_c_forEach_4 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          ...
          out.write('"');
          out.write(' ');
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${biblioteca.idtbiblioteca == signatura.stoidtbiblioteca?\"selected\":\"\"}", java.lang.String.class, (PageContext)_jspx_page_context, null));
          out.write('>');
