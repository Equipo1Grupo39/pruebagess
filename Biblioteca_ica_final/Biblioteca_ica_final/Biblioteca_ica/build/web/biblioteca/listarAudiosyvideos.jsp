        ...
        <div class="wrapper">    
            ...
            <div class="content-wrapper">
                ...
                <div class="content-header">
                    ...
                    <a href="audiosyvideoscontroller?action=nuevo" class="btn btn-success">Crear Audio y video</a>&nbsp;                 
                </div>            
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h3 class="card-title">Listado de Audios y videos</h3>
                                    </div>
                                    <!-- /.card-header -->
                                    <div class="card-body">
                                        <table class="table table-bordered table-hover">
                                            ...
                                            <tbody>
                                                <c:forEach var="audios" items="${lista}">
                                                    <tr>
                                                        <td> <c:out value="${audios.codigoaudiosyvideosisbn}"/></td>
                                                        <td> <c:out value="${audios.ayVtitulo}"/></td>
                                                        <td> <c:out value="${audios.ayVcontenido}"/></td> 
                                                        <td> <c:out value="${audios.autnombresapellidos}"/></td>
                                                        <td> <c:out value="${audios.matnombremateria}"/></td>
                                                        <td> <c:out value="${audios.edinombreeditorial}"/></td>
                                                        <td> <c:out value="${audios.idinombreidioma}"/></td>
                                                        <td> <c:out value="${audios.ayVcodigosignaturatopografica}"/></td>
                                                        <td> <c:out value="${audios.invcantidad}" /></td>
                                                        <td> <c:out value="${audios.ayVfechacreacion}"/></td>
                                                        <td><a class="btn btn-warning" href="audiosyvideoscontroller?action=showedit&codigo=<c:out value="${audios.codigoaudiosyvideosisbn}" />">Editar</a></td>
                                                        <td><a class="btn btn-danger" href="audiosyvideoscontroller?action=eliminar&codigo=<c:out value="${audios.codigoaudiosyvideosisbn}"/>">Eliminar</a> </td>	                        
                                                    </tr>
                                                </c:forEach>
                                            </tbody>
                                        </table>
