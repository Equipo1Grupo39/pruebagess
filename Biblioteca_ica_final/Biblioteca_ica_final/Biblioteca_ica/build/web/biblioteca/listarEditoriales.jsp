                                        ...
                                        <table class="table table-bordered table-hover">
                                            ...
                                            <tbody>
                                                <c:forEach var="editorial" items="${lista}">
                                                    <tr>
                                                        <td> <c:out value="${editorial.codigoeditorial}"/></td>
                                                        <td> <c:out value="${editorial.edinombreeditorial}"/></td>
                                                        <td><a class="btn btn-warning" href="editorialcontroller?action=showedit&codigo=<c:out value="${editorial.codigoeditorial}" />">Editar</a></td>
                                                        <td><a class="btn btn-danger" href="editorialcontroller?action=eliminar&codigo=<c:out value="${editorial.codigoeditorial}"/>">Eliminar</a> </td>	                        
                                                    </tr>
                                                </c:forEach>
                                            </tbody>
                                        </table>
