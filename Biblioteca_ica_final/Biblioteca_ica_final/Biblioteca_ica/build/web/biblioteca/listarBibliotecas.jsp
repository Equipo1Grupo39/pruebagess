        ...
        <div class="wrapper">    
            ...
            <div class="content-wrapper">
                ...
                <div class="content-header">
                    ...
                    <a href="tbibliotecaController?action=nuevo" class="btn btn-success">Crear biblioteca</a>&nbsp;                 
                </div>            
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h3 class="card-title">Listado de Bibliotecas</h3>
                                    </div>
                                    <!-- /.card-header -->
                                    <div class="card-body">
                                        <table class="table table-bordered table-hover">
                                            ...
                                            <tbody>
                                                <c:forEach var="biblioteca" items="${lista}">
                                                    <tr>
                                                        <td> <c:out value="${biblioteca.idtbiblioteca}"/></td>
                                                        <td> <c:out value="${biblioteca.tbinombre}"/></td>
                                                        <td> <c:out value="${biblioteca.tbinit}"/></td>
                                                        <td> <c:out value="${biblioteca.tbiemail}"/></td>
                                                        <td> <c:out value="${biblioteca.tbidireccion}"/></td>
                                                        <td> <c:out value="${biblioteca.tbitelefono}"/></td>
                                                        <td> <c:out value="${biblioteca.tbicuentabancaria}"/></td>
                                                        <td> <c:out value="${biblioteca.tbinombrebanco}"/></td>
                                                        <td><a class="btn btn-warning" href="tbibliotecaController?action=showedit&codigo=<c:out value="${biblioteca.idtbiblioteca}" />">Editar</a></td>
                                                        <td><a class="btn btn-danger" href="tbibliotecaController?action=eliminar&codigo=<c:out value="${biblioteca.idtbiblioteca}"/>">Eliminar</a> </td>	                        
                                                    </tr>
                                                </c:forEach>
                                            </tbody>
                                        </table>
