                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form name="crear" class="form-signin" method="post" action="<%=request.getContextPath()%>/prestamoscontroller">  
                                        <input type="hidden" name="action" value="register">
                                        <input type="hidden" name="pridusuario" value="${pridusuario}">
                                        <table class="table table-bordered table-hover">
                                            <tr>
                                                <td>Usuario: </td>
                                                <td>
                                                    <select name="usuarioPr">
                                                        <c:forEach var="usuario" items="${listaUsuario}">
                                                            <option value="${usuario.idusuario}" ${usuario.idusuario == pridusuario?"selected":""}>${usuario.usulogin} - ${usuario.usunombresapellidos}</option>
                                                        </c:forEach>
                                                    </select> 
                                                </td>                          
                                            </tr>
                                                ...
                                                <td>
                                                    <select name="administrador">
                                                        <c:forEach var="administrador" items="${listaAdmon}">
                                                            <option value="${administrador.idusuario}" ${administrador.idusuario == usuario.idusuario?"selected":""}>${administrador.usulogin} - ${administrador.usunombresapellidos}</option>
                                                        </c:forEach>
                                                    </select> 
                                                </td>                          
                                            </tr>                    
