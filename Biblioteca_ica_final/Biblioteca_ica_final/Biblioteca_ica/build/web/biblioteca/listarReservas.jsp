...
<html>
    <head>
        ...
        <title>Reservas | Sistema Biblioteca</title>
        ...
        <div class="wrapper">    
                        ...
                        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                            ...
                            <li class="nav-item has-treeview menu-open">
                                ...
                                <ul class="nav nav-treeview">
                                    ...
                                    <li class="nav-item">
                                        <a href="<%=request.getContextPath()%>/reservascontroller?action=index" class="nav-link active">
            ...
            <div class="content-wrapper">
                ...
                <div class="content-header">
                    ...
                    <a href="reservascontroller?action=nuevo" class="btn btn-success">Registrar reserva</a>&nbsp;                 
                </div>   
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">  
                                        ...
                                        <br />                                        
                                        <form name="listar" class="form-signin" method="post" action="<%=request.getContextPath()%>/reservascontroller">
                                            <input type="hidden" name="action" value="mostrar">
                                            <table class="table table-bordered table-hover">
                                                <tr>
                                                    <td>Usuario: </td>
                                                    <td><input type="text" name="cedula" size="10" value="${usuarioRe.usucedula}"></td>
                                                </tr> 
                                                <tr>
                                                    <td>Nombre: </td>
                                                    <td><input type="text" name="nombre" size="100"  value="${usuarioRe.usunombresapellidos}"></td>
                                                </tr> 
                                            </table>
                                            <br />
                                            <table class="table table-bordered table-hover">
                                                ...
                                                <div class="justify-content-center">
                                                    <a href="javascript:enviarForma('mostrar')" class="btn btn-info">Listar reservas</a>&nbsp;
                                                </div> 
                                                </td></tr>
                                            </table>                                            
                                            <br />
                                            ...
                                            <table class="table table-bordered table-hover">
                                                ...
                                                <tbody>
                                                    <c:forEach var="reserva" items="${lista}">
                                                        <tr>
                                                            <td> <c:out value="${reserva.titulo}"/></td>
                                                            <td> <c:out value="${reserva.resfechareserva}"/></td> 
                                                            <td> <c:out value="${reserva.resfechaactualizacion}"/></td>
                                                            <td> <c:out value="${reserva.nombreAdmon}"/></td>
                                                            <c:if test="${reserva.tipo == 'L'}">
                                                                <td> <c:out value="Libro"/></td>
                                                            </c:if>  
                                                            <c:if test="${reserva.tipo == 'A'}">
                                                                <td> <c:out value="Audio y video"/></td>
                                                            </c:if>                                  
                                                            <c:if test="${reserva.resestado == 'A'}">
                                                                <td> <c:out value="Activa"/></td>
                                                            </c:if>  
                                                            <c:if test="${reserva.resestado == 'C'}">
                                                                <td> <c:out value="Cancelada"/></td>
                                                            </c:if>  
                                                            <c:if test="${reserva.resestado == 'P'}">
                                                                <td> <c:out value="Registra prestamo"/></td>
                                                            </c:if>  
                                                            <c:if test="${reserva.resestado != 'C'}">
                                                                <td>
                                                                    <a class="btn btn-warning" href="reservascontroller?action=prestar&reserva=<c:out value="${reserva.codigoreservas}" />&usuario=<c:out value="${reserva.residusuario}" />">Prestar</a>
                                                                    <a class="btn btn-danger" href="reservascontroller?action=cancelar&reserva=<c:out value="${reserva.codigoreservas}" />&usuario=<c:out value="${reserva.residusuario}" />">Cancelar</a>
                                                                </td>
                                                            </c:if> 
                                                        </tr>
                                                    </c:forEach>
