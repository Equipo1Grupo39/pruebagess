        ...
        <div class="wrapper">    
            ...
            <div class="content-wrapper">
                ...
                <div class="content-header">
                    ...
                    <a href="autorcontroller?action=nuevo" class="btn btn-success">Crear Autor</a>&nbsp;                 
                </div>            
                                        ...
                                        <table class="table table-bordered table-hover">
                                            ...
                                            <tbody>
                                                <c:forEach var="autor" items="${lista}">
                                                    <tr>
                                                        <td> <c:out value="${autor.codigoautor}"/></td>
                                                        <td> <c:out value="${autor.autnombresapellidos}"/></td>
                                                        <td> <c:out value="${autor.autnacionalidad}"/></td>
                                                        <td><a class="btn btn-warning" href="autorcontroller?action=showedit&codigo=<c:out value="${autor.codigoautor}" />">Editar</a></td>
                                                        <td><a class="btn btn-danger" href="autorcontroller?action=eliminar&codigo=<c:out value="${autor.codigoautor}"/>">Eliminar</a> </td>	                        
                                                    </tr>
                                                </c:forEach>
                                            </tbody>
                                        </table>
