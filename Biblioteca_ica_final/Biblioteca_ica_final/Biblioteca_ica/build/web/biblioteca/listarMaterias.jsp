...
<html>
    <head>
        ...
        <title>Materias | Sistema Biblioteca</title>
        ...
        <div class="wrapper">    
                        ...
                        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                            ...
                            <li class="nav-item has-treeview menu-open">
                                ...
                                <ul class="nav nav-treeview">
                                    ...
                                    <li class="nav-item">
                                        <a href="<%=request.getContextPath()%>/materiacontroller?action=mostrar" class="nav-link active">
            ...
            <div class="content-wrapper">
                ...
                <div class="content-header">
                    ...
                    <a href="materiacontroller?action=nuevo" class="btn btn-success">Crear Materia</a>&nbsp;                 
                </div>            
                                        ...
                                        <table class="table table-bordered table-hover">
                                            ...
                                            <tbody>
                                                <c:forEach var="materia" items="${lista}">
                                                    <tr>
                                                        <td> <c:out value="${materia.codigomateria}"/></td>
                                                        <td> <c:out value="${materia.matnombremateria}"/></td>
                                                        <td><a class="btn btn-warning" href="materiacontroller?action=showedit&codigo=<c:out value="${materia.codigomateria}" />">Editar</a></td>
                                                        <td><a class="btn btn-danger" href="materiacontroller?action=eliminar&codigo=<c:out value="${materia.codigomateria}"/>">Eliminar</a> </td>	                        
                                                    </tr>
                                                </c:forEach>
                                            </tbody>
                                        </table>
