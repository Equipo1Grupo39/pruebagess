    ...
    function enviarForma(enviar)
        {
            ...
            var paginas = document.forms["crear"]["paginas"];
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form name="crear" class="form-signin" method="post" action="<%=request.getContextPath()%>/libroscontroller">  
                                        ...
                                        <table class="table table-bordered table-hover">
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="number" name="paginas" size="50" required></td>     
                                            </tr>  
                                            <tr>
                                                <td>Autor: </td>
                                                <td>
