    ...
    function enviarForma(enviar)
        {
            ...
            var nacionalidad = document.forms["editar"]["nacionalidad"];
                        ...
                        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                            ...
                            <li class="nav-item has-treeview menu-open">
                                ...
                                <ul class="nav nav-treeview">
                                    ...
                                    <li class="nav-item">
                                        <a href="<%=request.getContextPath()%>/autorcontroller?action=mostrar" class="nav-link active">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form name="editar" class="form-signin" method="post" action="<%=request.getContextPath()%>/autorcontroller">  
                                        <input type="hidden" name="action" value="editar">
                                        <input type="hidden" name="codigo" value="${autor.codigoautor}">
                                            <table class="table table-bordered table-hover">
                                                <tr>
                                                    <td>Código: </td>
                                                    <td><input type="text" size="50" value="${autor.codigoautor}" disabled = "true"></td>
                                                </tr>                    
                                                <tr>
                                                    <td>Nombre: </td>
                                                    <td><input type="text" id="nombre" name="nombre" size="50" value="${autor.autnombresapellidos}" required></td>
                                                </tr>
                                                <tr>
                                                    <td>Nacionalidad: </td>
                                                    <td><input type="text" id="nombre" name="nacionalidad" size="50" value="${autor.autnacionalidad}" required></td>
                                                </tr>
                                            </table>
                                            <br />
